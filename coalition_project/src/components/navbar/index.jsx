...
export default function Navbar(){
    return <div className="flex flex-row justify-between p-5  rounded-full bg-[#FFFFFF]">
        <div><img src="src/components/navbar/TestLogo.svg" alt="Logo" /></div>
        ...
        <div className="flex flex-row justify-center">
            <img src="src/components/navbar/senior-woman-doctor-and-portrait-smile-for-health-2023-11-27-05-18-16-utc.png" alt="profile picture of 1st object" />
