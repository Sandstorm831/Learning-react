...
import { completeData, line_data } from '../../store/atoms/fetchData';
    ...
    return <div className='flex flex-col h-full bg-white rounded-xl p-5'>
        ...
        <div className='flex justify-between'>
            <div className='flex flex-col bg-[#E0F3FA] rounded-lg w-full h-[300px] p-5 mr-5'>
                <div className='h-max flex '><div className='w-max'><img src='src/components/diagnosisHistory/respiratory rate.svg' alt='lung pic' height={150} width={150}/></div></div>
            ...
            <div className='h-max flex '><div className='w-max'><img src='src/components/diagnosisHistory/temperature.svg' alt="thermometer picture"  height={150} width={150}/></div></div>
            ...
            <div className='h-max flex '><div className='w-max'><img src='src/components/diagnosisHistory/HeartBPM.svg' alt="heart bp pic" height={150} width={150}/></div></div>
